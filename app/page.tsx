...
export default async function HomePage() {
  ...
  const heroPortrait = profile?.photo_url ?? `${managedAssetHost}/manus-storage/temporary-hero-portrait-unsplash_b4117910.jpg`;
