...
const contentType = z.enum(["profile", "education", "publications", "experiences", "skills", "projects", "media"]);
...
export const appRouter = router({
  ...
  portfolio: router({
    ...
    remove: adminProcedure.input(z.object({ type: z.enum(["education", "publications", "experiences", "skills", "projects", "media"]), id: z.number().int().positive() })).mutation(({ input }) => deleteContent(input.type, input.id)),
