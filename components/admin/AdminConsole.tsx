...
const tabs: TabDefinition[] = [
  ...
  },
  {
    ...
    group: "Portfolio foundation",
    icon: FileText,
    template: { title: "", venue: "", publication_date: "", status: "", authors: "", doi: "", summary: "", details: "", keywords: [], url: "", sort_order: 0 },
    fields: [
      ...
      { key: "doi", label: "DOI", placeholder: "10.1109/example.2026.1234567", nullable: true, help: "The permanent DOI identifier shown on the research page." },
