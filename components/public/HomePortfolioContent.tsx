...
export function HomePortfolioContent({ initialPortfolio }: { initialPortfolio: PortfolioSnapshot }) {
  ...
  const hasManagedPortrait = Boolean(profile?.photo_path);
  ...
  const heroPortrait = profile?.photo_path ?? temporaryPortraitUrl;
